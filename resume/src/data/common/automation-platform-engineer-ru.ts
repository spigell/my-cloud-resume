...
const variantHighlights: Partial<Record<WorkKey, string[]>> = {
  ...
  amarkets: withStack(
    ...
    [
      ...
      'Проводил автоматизацию миграции монолитов и микросервисов в Kubernetes, упаковав паттерны взаимодействия сервисов в переиспользуемые потоки.',
      'Добавил автоматические отчеты для мониторинга быстродействия PostgreSQL (длительные запросы, висящие запросы, использование диска и т.д.).',
    ],
    StackLabel.Russian,
  ),
  gaijin: withStack(
