...
const variantHighlights: Partial<Record<WorkKey, string[]>> = {
  freelance: withStack(
    'freelance',
    [
      'Автоматизировал развертывание инфраструктуры Kubernetes с помощью Pulumi и Helm для ускорения мульти-облачных деплоев.',
      'Шаблонизировал стеки для GKE и Hetzner/Talos, чтобы сделать инфраструктуру воспроизводимой и управляемой кодом.',
      'Поддерживал OSS-инструментарий pulumi-talos-cluster, благодаря чему бутстрапинг Talos теперь бесшовно встраивается в CI-процессы.',
