...
const variantHighlights: Partial<Record<WorkKey, string[]>> = {
  trading_startup: withStack('trading_startup', [
    ...
    'FinOps: Budget management, cost visibility, and cluster rightsizing',
  ]),
  ...
  gaijin: withStack('gaijin', [
    ...
    'Provide Packer templates for creating game servers quickly',
  ]),
  ...
  rostelecom: withStack('rostelecom', [
    ...
    'Using the internal VMware vSphere cloud to provision new VMs',
  ...
  equilibrium: withStack('equilibrium', [
    ...
    'Manage AWS nodes via Ansible and Chef',
  ]),
...
export const data: Data = {
  basics: {
    ...
    summary: `Designs resilient multi-cloud platforms (AWS, GCP) with a Kubernetes-first mindset (Deckhouse, Talos), leveraging Terraform, Pulumi, and Helm along with automation-driven workflows to ship reliable infrastructure.`,
  },
